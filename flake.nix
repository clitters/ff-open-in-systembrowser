        ...
        nixosModules.default = { config, lib, pkgs, ... }:  
          ...
          {  
            ...
            config = mkIf cfg.enable {  
              environment.systemPackages = [  
                self.packages.${system}.native-host  
              ];  
              ...
              environment.etc."mozilla/native-messaging-hosts/open_in_systembrowser.json".source =  
                "${self.packages.${system}.native-host}/lib/mozilla/native-messaging-hosts/open_in_systembrowser.json";  
            };  
          };
          ...
          homeManagerModules.default = { config, lib, pkgs, ... }:  
            ...
            {  
              ...
              config = mkIf cfg.enable {  
                home.packages = [ self.packages.${system}.native-host ];  
